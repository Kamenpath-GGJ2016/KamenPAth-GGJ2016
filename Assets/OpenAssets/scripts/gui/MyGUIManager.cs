...
public class MyGUIManager : MonoBehaviour 
{
    ...
    protected static MyGUIManager _instance;
	
	// Singleton pattern
	public static MyGUIManager Instance
	{
		get
		{
			if(_instance == null)
				_instance = GameObject.FindObjectOfType<MyGUIManager>();
			return _instance;
		}
	}
	...
	public virtual void RefreshPoints()
	{
        if (PointsText!= null)
        { 
    		PointsText.text=MyGameManager.Instance.Points.ToString("000000");
        }
    }
